...
class Settings extends React.Component {
  ...
  checkForAdmin() {
    if(this.state.user) {
      ...
      console.log("EVN Var??");
      console.log(process.env.REACT_APP_ADMIN_PEEPS[0]);
      console.log(process.env.REACT_APP_ADMIN_PEEPS[1]);
      if(this.state.user.email == "davis.christopher.w@gmail.com") {
        return "Admin!";
      } else {
        return "Normal";
      }
